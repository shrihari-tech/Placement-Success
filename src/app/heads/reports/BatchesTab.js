              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {searchResults.map((student, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 ">
                      <span
                        className={`px-2 py-1 min-w-[70px] rounded-full text-xs font-medium ${
                          student.placement === "Placed"
                            ? "bg-green-100 text-green-800"
                            : student.placement === "Not Placed"
                            ? "bg-red-100 text-red-800"
                            : student.placement === "Yet to Place"
                            ? "bg-yellow-100 text-yellow-800"
                            : student.placement === "Not Required"
                            ? "bg-gray-100 text-gray-800"
                            : "bg-blue-100 text-blue-800"
                        }`}
                      >
                        {student.placement || "Unknown"}
                      </span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 ">
                      <button
                        onClick={() => handleViewDetails(student)}
                        className="p-1.5 text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded-full transition-colors duration-200 active:scale-95"
