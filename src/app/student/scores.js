                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {filteredScores.map((student, index) => (
                                    <tr key={student.bookingId} className="hover:bg-[#f4f3ff] hover:text-gray-900 text-gray-500">
                                        <td className="px-4 text-gray-700 text-center py-3 text-sm whitespace-nowrap">{index + 1}</td>
                                        <td className="px-4 py-3 text-center  text-sm whitespace-nowrap">{student.name}</td>
                                        <td className="px-4 py-3 text-center  text-sm whitespace-nowrap">{student.email}</td>
                                        <td className="px-4 py-3 text-center  text-sm whitespace-nowrap">{student.bookingId}</td>
                                        <td className="px-4 py-3 text-center  text-sm whitespace-nowrap">{student.phone}</td>
