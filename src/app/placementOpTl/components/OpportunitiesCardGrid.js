  ...
  if (items.length === 0) {
    return (
      <div className="col-span-full w-full py-8 sm:py-12 text-center">
        <div className="inline-block p-3 sm:p-4 bg-[#ece3d8] rounded-full mb-3 sm:mb-4">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 sm:h-12 sm:w-12 text-[#a17640]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {totalPages > 1 && (
        <div className="flex justify-center items-center my-4 sm:my-6 space-x-1 sm:space-x-2">
          <button
            ...
            className="p-1.5 sm:p-2 rounded-full text-[#a17640] hover:bg-[#ece3d8] disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            if (page === 1 || page === totalPages || (page >= currentPage - 1 && page <= currentPage + 1)) {
              return (
                <button
                  ...
                  className={`cursor-pointer px-2 py-1 sm:px-3 sm:py-1 rounded-md text-xs sm:text-sm ${currentPage === page ? 'bg-[#a17640] text-white' : 'text-[#a17640] hover:bg-[#ece3d8]'}`}
