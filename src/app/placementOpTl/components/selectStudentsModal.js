//src/app/placementOpTl/components/selectStudentsModal.js
"use client";
...
const SelectStudentsModal = ({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-4xl bg-[#F8FAFD] rounded-[10px] p-6 animate-fade-in-up max-h-[90vh] flex flex-col"
      ...
      >
        ...
        <div className="flex justify-evenly gap-2 md:gap-1 flex-wrap items-center mb-4 p-3 bg-[#fff9e6] rounded flex-shrink-0">
          <div
            className={`bg-[#ece3d8] rounded-md border-t-3 border-[#a17640] shadow p-1 md:p-2`}
          >
          ...
          >
            <p className="text-sm p-1">
              ...
              <span className="text-gray-700">
                {formatDate(opportunityDetails.driveDate)}
              </span>
            </p>
          </div>
          <div
          ...
          >
            <p className="text-sm p-1">
              ...
              <span className="text-gray-700">{opportunityDetails.domain}</span>
            </p>
          </div>
          <div
            className={`bg-[#ece3d8] rounded-md border-t-3 border-[#a17640] shadow p-1 md:p-2`}
