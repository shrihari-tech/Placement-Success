          ...
          <div className="p-6">
            ...
            <div className="w-full mt-4 mb-6">
              ...
              <div className="cursor-pointer relative">
                ...
                {/* Animated underline */}
                <div
                  className="cursor-pointer absolute bottom-0 left-0 h-[3px] bg-[#cd5e77] transition-all duration-300 ease-in-out"
                  style={{
            ...
            <div>
              ...
              {/* Score Card Tab Content (Placeholder) */}
              {activeTab === "Score Card" && (
                <div className="p-4 text-center text-gray-500">
                  <p>Score Card content will go here.</p>
                </div>
              )}

              {/* Placement Tab Content (Placeholder) */}
              {activeTab === "Placement" && (
                <div className="p-4 text-center text-gray-500">
                  <p>Placement content will go here.</p>
                </div>
              )}
            </div>
            {/* End Tab Content */}
